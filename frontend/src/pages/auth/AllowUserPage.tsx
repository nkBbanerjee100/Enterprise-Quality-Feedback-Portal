/**
 * Allow User Page
 * Accessible only by Quality + Manager (admin) roles via the sidebar.
 *
 * Admin supplies ONLY Email + Role here — NO name, NO password.
 * This is stored in the csat_allowed_users allow-list table.
 * The employee then self-registers on the public /register-self page,
 * filling in their own EmpId/name/gender/password — but the backend
 * will only let them through if their email is in this allow-list,
 * and will force their role to whatever is set here.
 */
